...
<body>
	...
	<script>
		...
		function submitForm() {
			var tmonth = $("#trainingMonth").val();
			var tyear = $("#trainingYear").val();
			var trainingregstartdt = $("#startDate").val();
			var trainingregenddt = $("#endDate").val();
			var tagency = $("#agency").val();
			var tname = $("#tname").val();
			var tsubject = $("#subject").val();
			var tcategory = $("#category").val();
			var tspell = $("#spell").val();
			var tdescription = $("#description").val();
			var preferdlocation = $("#venue").val();
			var tgrade = $("#grade").val();
			var ttargetgroup = $("#group").val();
			var numberofstakeholder = $("#stakeholders").val();
			var numberdayneeded = $("#dayNeeded").val();
			var tmode = $("#mode").val();
			var thoursperday = $("#hoursPerDay").val();
			var totalhours = $("#totalHours").val();
			var tstatus = $("#status").val();

			// Basic validation example (you can customize this as needed)
			if (!tmonth || !tyear || !trainingregstartdt || !trainingregenddt
					|| !tagency || !tname || !tsubject || !tcategory || !tspell
					|| !tdescription || !preferdlocation || !tgrade
					|| !ttargetgroup || !numberofstakeholder
					|| !numberdayneeded || !tmode || !thoursperday
					|| !totalhours || !tstatus) {
