...
.btn-disabled12 {
	background-color: #b3f5c3 !important;
	/* Set your desired background color for the disabled state */
	border-color: red !important;
	/* Set your desired border color for the disabled state */
	...
	<script>
				...
				success : function(data) {
					...
					if (data === null || data.length === 0) {
						...
						$("#messageContainer").text(
								"No on-going trainings available.");
		...
		function displayTrainingData(data) {
			...
			for (var i = 0; i < trainings.length; i++) {
				...
				row.insertCell(12).innerHTML = training.venue_name + ', '
						+ training.vaddress;
		...
		function checkAndDisableApplyButtons() {
			...
			for (var i = 1; i < table.rows.length; i++) {
				...
				let applyNowButton = table.rows[i].cells[16]
