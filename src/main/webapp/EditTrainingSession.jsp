...
<body>
	...
	<div>
		<label for="toDate">To Date:</label> <input type="text" id="toDate">
	</div>
	<div>
	...
	<div>
		<label for="recordstatus"> Record Status:</label> <input type="text"
			id="recordstatus" readonly>
	</div>
