	...
	<h1>Add Trainee Limit</h1>
		<form id="addSessionForm" class="text-left" onsubmit="return saveForm()">
		        ...
		        <div class="form-column">
		            <label for="expense_type">Expense_type:</label>
			            <select id="expense_type" placeholder="Enter Expense_type"  required>
			            <option value="TA&DA">TA&DA</option>
						    <option value="Accomodations">Accomodations</option>    
			            </select>
			            
			         <label for="trainee_role">Trainee_role:</label>
			            <select id="trainee_role" placeholder="Enter trainee_role"  required>
